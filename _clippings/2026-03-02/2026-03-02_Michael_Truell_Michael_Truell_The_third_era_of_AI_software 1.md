...
I’d love a "low confidence" intercept when the agent admits it’s guessing. Instead of confidently writing potentially broken code, it should stop and present a fork so I can point it in the right direction before it wastes additional tokens.