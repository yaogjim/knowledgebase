---
title: "2026-03-06_AppSail_AppSail_OpenClaw_QMD_本地语义搜索_ZenMux_节省_20"
...
> ArticleMoltbot 新手安装教程，VPS 购买-安装-安全配置-实战体验一条龙昨晚在 WaytoAGI 直播分享了 Moltbot 的玩法、安装流程以及很多安全方面的内容。很多朋友私信问具体怎么安装，这篇文章就把整个流程从头到尾写清楚。 Moltbot 是什么？ Moltbot（原名 Clawdbot）是一个可以在本地或...
> 
> — AppSail
> 
...
謝謝樓主的提供參數，我什麼都不會，只能動動手只讓 openclew 自己爬文檔參數自己修改然後自己重啟 ※AI 模型我選用 nvidia 的 llama-3.3-70b-instruct ※我給 openclew 的角色設定是資深運維與資深的 openclew 開發人員，每次修改配置之前都要先去查看手冊文檔參照, 修改之前都要先備份

**@Undead** ♥ 5 · 💬 1

https:// github.com/undead-undead/ aagt/tree/main/aagt-qmd …异曲同工
...
QMD 不是 rust 实现的吧，是 ts和python

**@AppSail** ♥ 1 · 💬 1

对哦，搞错了，bun 怎么回事 rust，我明天改一下