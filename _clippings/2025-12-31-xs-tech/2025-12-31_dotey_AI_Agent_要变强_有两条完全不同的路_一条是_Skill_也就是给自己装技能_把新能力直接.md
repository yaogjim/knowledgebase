---
title: "2025-12-31_dotey_AI_Agent_要变强_有两条完全不同的路_一条是_Skill_也就是给自己装技能_把新能力直接"
...
**潦草学者 Scholar.L** @liaocaoxuezhe [2025-12-24](https://x.com/liaocaoxuezhe/status/2003750247970054620)

SubAgent 和 Skills 的结合，我也写了一篇很好的文章《用Kimi-K2+ClaudeCode做了条Agent流水线，节省90%的时间 | Subagent+Skills的最佳实践》https://mp.weixin.qq.com/s/dHyiq1mAHv61FHDpbbPL5Q…

不过可惜的是现在 Claude Code 里面 SubAgent 还不具备使用 Skills 的能力，只能通过检索文件的方式来按照 skills 的说明操作。

![Image](https://pbs.twimg.com/media/G87AOHdaQAAEP7T?format=jpg&name=large)

* * *

**破茧 | Unbound** @PojianTalks [2025-12-24](https://x.com/PojianTalks/status/2003966134211813637)

说白了，还是上下文工程（context engineering）这一套。

skill读取简介的加载方式为了省上下窗口，简单常用任务用skill处理。

subagent用于处理上下文容易暴增的任务，只传递核心结果给主agent。

两者在的组合是平衡效率、精确性，防止上下文爆炸，造成agent糊涂🤦‍♂️