---
title: "2026-06-16_dotey_Anthropic_今天发了一个新产品_可能会让一批做_AI_智能体基础设施的团队失业"
...
> 推出 Claude 托管代理：构建和部署大规模代理所需的一切。 它将一个针对性能优化的 agent harness 与生产环境基础设施相结合，因此您可以在几天内完成从原型到发布的过程。 现在在 Claude 平台上处于公开测试阶段。
> 
> — Claude
> 
> [https://x.com/claudeai/status/2041927687460024721](https://x.com/claudeai/status/2041927687460024721)
> 
> ![图片](https://pbs.twimg.com/profile_images/1950950107937185792/QOfEjFoJ_x96.jpg)![图片](https://pbs.twimg.com/profile_images/1798110641414443008/XP8gyBaY_bigger.jpg)![Download](chrome-extension://jfphcjkiccfhcmggdncpidahnkfpngfa/blueicon.jpg)
...
[@dongxi\_nlp](https://x.com/@dongxi_nlp)）有一个精辟的总结：

> 本地的 Harness 是徒劳的，因为随着模型迭代问题本身被解决，针对旧模型局限而精心设计的 Harness 便失去了存在的意义。 换句话说，制造商最清楚模型的局限性，他们可以完全根据模型的特性设计不同的夹具，然后打包卖给你。 这个包，就是 Managed Agents
> 
> — 马东锡 NLP
> 
> [https://x.com/dongxi\_nlp/status/2041954843107979356](https://x.com/dongxi_nlp/status/2041954843107979356)
> 
> ![图片](https://pbs.twimg.com/profile_images/1955352181453774848/QfD9wuqD_x96.jpg)![Square profile picture](https://pbs.twimg.com/profile_images/1798110641414443008/XP8gyBaY_normal.jpg)
...
> @NotionHQ 让团队能够直接在他们的工作区中将工作委派给 Claude。数十个任务并行运行，整个团队协作处理产出。现已在私有 Alpha 阶段可用：
> 
> — Claude
> 
> [https://x.com/claudeai/status/2041927691268497548](https://x.com/claudeai/status/2041927691268497548)
> 
> ![图片](https://pbs.twimg.com/profile_images/1950950107937185792/QOfEjFoJ_x96.jpg)![图片](https://pbs.twimg.com/profile_images/1798110641414443008/XP8gyBaY_bigger.jpg)![图片](https://pbs.twimg.com/card_img/2041983691820560387/Z3kHEW4y?format=jpg&name=large)
...
Anthropic 工程团队写了一篇技术博客

[扩展托管代理：将大脑与手解耦](https://www.anthropic.com/engineering/managed-agents)，讲了 Managed Agents 背后的架构演进。

> 工程博客新文章: 构建托管代理——我们的长期运行代理托管服务——意味着解决计算领域的一个老问题：如何为“尚未被想到的程序”设计一个系统。 阅读更多：
> 
> — Anthropic
> 
> [https://x.com/AnthropicAI/status/2041929199976640948](https://x.com/AnthropicAI/status/2041929199976640948)
> 
> ![Square profile picture](https://pbs.twimg.com/profile_images/1798110641414443008/XP8gyBaY_x96.jpg)![Anthropic logo](https://pbs.twimg.com/card_img/2041928747121852416/m9eI15mL?format=jpg&name=large)
...
推出 Claude 托管代理：构建和部署大规模代理所需的一切。

它将一个针对性能优化的 agent harness 与生产环境基础设施相结合，因此您可以在几天内完成从原型到发布的过程。

现在在 Claude 平台上处于公开测试阶段。

**@9h** ♥ 2.4K · 💬 129

工程博客新文章:

构建托管代理——我们的长期运行代理托管服务——意味着解决计算领域的一个老问题：如何为“尚未被想到的程序”设计一个系统。
...
让团队能够直接在他们的工作区中将工作委派给 Claude。数十个任务并行运行，整个团队协作处理产出。现已在私有 Alpha 阶段可用：

**@7h** ♥ 179 · 💬 10

本地的 Harness 是徒劳的，因为随着模型迭代问题本身被解决，针对旧模型局限而精心设计的 Harness 便失去了存在的意义。

换句话说，制造商最清楚模型的局限性，他们可以完全根据模型的特性设计不同的夹具，然后打包卖给你。
