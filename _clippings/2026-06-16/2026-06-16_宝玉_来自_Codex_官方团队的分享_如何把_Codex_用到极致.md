---
title: "2026-06-16_dotey_来自_Codex_官方团队的分享_如何把_Codex_用到极致"
source: "https://x.com/dotey/status/2057250417638035555"
author:
  - "[[@dotey]]"
...
[@jxnlco](https://x.com/@jxnlco)) 原文：

> 充分利用 Codex大多数开发者首先使用编码代理来处理代码：检查代码仓库、生成差异、运行测试并打开拉取请求。 这仍然是 Codex 的核心重心。但在很多工作上...
> 
> — jason
> 
> [https://x.com/jxnlco/status/2057153744630890620](https://x.com/jxnlco/status/2057153744630890620)
> 
> ![图片](https://pbs.twimg.com/profile_images/2057561784047816704/5Su5xy1d_x96.jpg)![Article cover image](https://pbs.twimg.com/media/HIx6TgrX0AAdNFj?format=jpg&name=large)![Download](chrome-extension://jfphcjkiccfhcmggdncpidahnkfpngfa/blueicon.jpg)
...
- [$浏览器](https://developers.openai.com/codex/app/browser) 在侧边栏中运行的应用内浏览器，Codex 可以在这里审查网页并在上面做标记。
...
[$browser](https://x.com/search?q=%24browser&src=cashtag_click) 适合在侧边栏做网页审查；

[@chrome](https://x.com/@chrome)

适合那些需要你账号登录状态的浏览器内工作；而

[@computer](https://x.com/@computer)

则用来搞定那些只能在电脑桌面上点来点去的任务。

MCP 服务器和各类连接器把这种能力进一步延伸到了你的整个工作流中。

[Slack 集成](https://developers.openai.com/codex/integrations/slack)、以及各种

[MCP 工具连接器](https://developers.openai.com/api/docs/guides/tools-connectors-mcp)

和

[MCP 指南](https://developers.openai.com/api/docs/guides/tools-connectors-mcp)

之所以重要，是因为很多关键任务在变成代码之前，最初往往只是一条聊天消息、一封收件箱里的邮件，或者一个日程安排问题。

技能 (Skills) 让那些重复的工作流可以被反复利用。一旦某个工作流被证明好用，你可以将它

[固化为技能](https://developers.openai.com/codex/skills)，这样 Codex 下次就能直接跑通，而不需要从头开始重新学习这个流程。
...
![Image](https://pbs.twimg.com/media/HIzQFlCXkAAo-jU?format=jpg&name=large)

你的幻灯片或 PDF 就乖乖敞开在对话框旁边，随时等你检阅和修改。

![Image](https://pbs.twimg.com/media/HIzQP6RWMAAhrRX?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HIzQTj7XUAEPHXK?format=jpg&name=large)
...
Codex 自己也在 设置 > 个性化 > 记忆 中提供官方的

[记忆功能](https://developers.openai.com/codex/memories)。它们就像是系统自带的本地记事本，用来记住你的个人偏好、常用的工作流以及一些经常踩的坑。不过，这个功能是用来辅助你清晰写下来的上下文的，而不是取代它。

[Chronicle 记忆组件](https://developers.openai.com/codex/memories/chronicle)

也是同样的思路，它能帮 Codex 从你最近屏幕上发生的事情中提取并构建记忆。
...
We are building a smaller social platform for calm people.

No ads, no rage-bait, and strong moderation. You can join our waitlist now :)

**@Lentrox AI** ♥ 34 · 💬 2

Meet Lentrox - an AI that turns your thoughts into real outcomes, faster than ever.

**@Chase Chou** ♥ 5 · 💬 0

真巧，我昨天也写了一篇关于codex使用的SOP
