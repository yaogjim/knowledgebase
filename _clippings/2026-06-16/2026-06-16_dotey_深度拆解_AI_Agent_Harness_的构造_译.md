---
title: "2026-06-16_dotey_深度拆解_AI_Agent_Harness_的构造_译"
...
> 代理框架的结构深入探讨 Anthropic、OpenAI、Perplexity 和 LangChain 实际正在构建的内容。涵盖了编排循环、工具、记忆、上下文管理，以及其他所有能够改变...
> 
> — Akshay
> 
> [https://x.com/akshay\_pachaar/status/2041146899319971922](https://x.com/akshay_pachaar/status/2041146899319971922)
> 
> ![图片](https://pbs.twimg.com/profile_images/1578327351544360960/YFpWSWIX_x96.jpg)![Article cover image](https://pbs.twimg.com/media/HFOWvmAaIAAzGHg?format=jpg&name=large)![Download](chrome-extension://jfphcjkiccfhcmggdncpidahnkfpngfa/blueicon.jpg)
...
[@function\_tool](https://x.com/@function_tool) 定义）、托管工具（如网页搜索、代码解释器、文件搜索）以及 MCP （Model Context Protocol，一种开放的工具接入标准） 服务器工具。
...
现代 Harness 依赖于原生工具调用，即模型返回结构化的 tool\_calls 对象，而不是需要费力解析的自由文本。Harness 会检查：是否有工具调用？如果有，执行并继续循环；如果没有，那当前的输出就是最终答案。
