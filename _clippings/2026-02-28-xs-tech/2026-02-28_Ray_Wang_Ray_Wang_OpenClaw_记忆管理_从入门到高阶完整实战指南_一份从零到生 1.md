---
title: "2026-02-28_Ray_Wang_Ray_Wang_OpenClaw_记忆管理_从入门到高阶完整实战指南_一份从零到生"
...
大佬想问一下 这个agent 我应该怎么配合opencode等工具使用呢? 我自己是用skill完成了部分工作 但是每次新开一个session的时候 并不会自动加载我的skill
