---
title: "让 Codex 连续工作 8 小时"
source: "https://x.com/dotey/status/1972207923096142132"
author:
  - "[[@dotey]]"
...
description:
tags:
  - "@dotey #持续工作 #ClaudeCode #AGENT #工具 #自动化 #任务执行"
---
...
\# codex\_task\_monitor.sh — 运行的最小调度器

\# \`export TERM=xterm && codex 执行 "继续下一个任务" --全自动化\`

\# 每五分钟一次，并报告每次运行的结果。

---

**宝玉** @dotey [2025-09-28](https://x.com/dotey/status/1972347915764158721)

让它每次任务执行完更新一个 Plan 文件，说明下一步要做什么，并且 Agents MD 要引导 codex 每次先读取这个 Plan 文件，并且任务完成，更新这个文件
...
**宝玉** @dotey [2025-09-28](https://x.com/dotey/status/1972396450089718059)

之前的脚本每5分钟重启不够好，因为有些任务会超过5分钟，修改为如果没有新的输出超过1分钟（可配置），则视为任务结束，重新执行命令开始 codex 任务：
...
\# \`export TERM=xterm && codex exec "continue to next task"